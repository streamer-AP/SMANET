...
cfg_data.DATA_PATH = os.environ.get("CROHD_DATA_ROOT", "./data/CroHD")
cfg_data.FLOW_ROOT = os.environ.get("CROHD_FLOW_ROOT", "./data/CroHD/raft")
...
cfg_data.TRAIN_FRAME_INTERVALS = (95, 105)
cfg_data.VAL_FRAME_INTERVALS = 100
